            ...
            <div className="navcontainer ">
                <nav className="nav">
                    <div className="nav-upper-options">
                        <Link exact to='/admin/' onClick={()=>{setActive('dashboard')}}>
                        ...
                        <Link exact to='/admin/participants' onClick={()=>{setActive('participants')}} >
                        ...
                        <Link exact to='/admin/events' onClick={()=>{setActive('events')}} >
                        ...
                        <Link exact to='/admin/certificate' onClick={()=>{setActive('certificate')}} >
                        ...
                        <Link exact to='/admin/mail' onClick={()=>{setActive('mail')}} >
                        ...
                        <Link exact to='/admin/categories' onClick={()=>{setActive('categories')}} >
