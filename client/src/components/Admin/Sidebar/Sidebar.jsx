...
function Sidebar() {
    ...
    return (
        <div className="main-container">
            ...
            {showLogout &&
            <div className="absolute w-full h-full bg-opacity-50 bg-black items-centerjustify-center">
                <div className="logout-box w-50vh bg-white my-44 mx-auto text-center p-12">
                <h2>Logout</h2>
