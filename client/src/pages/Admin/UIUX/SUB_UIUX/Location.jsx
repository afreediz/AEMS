        ...
        <div className="edit-location">
            ...
            <form onSubmit={on_submit} className="w-full">
                <div className=" text-2xl font-semibold">
                    longitude : <input name='long' onChange={on_change} value={data && data.long} type="number" className='mx-2 outline outline-slate-700 mb-4 rounded border-2 border-slate-500 p-4 w-40'/> <br />
                    latitude : <input name='lat' onChange={on_change} value={data && data.lat} type="number" className=' mx-2 outline outline-slate-700 mb-4 rounded border-2 border-slate-500 p-4 w-40'/>
                </div>
